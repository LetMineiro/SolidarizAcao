...
public class DoacaoDAO {
    public void salvar(Doacao d) throws Exception {
        ...
        String sql = "INSERT INTO doacoes (id_doador, roupas, calcados, livros, brinquedos, alimentos, outro_item, outro_qtd, campanha) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        stmt.setString(9, d.getCampanha());
