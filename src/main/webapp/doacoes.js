...
function enviarFormulario(evt) {
  ...
  // Se não houver erros, o formulário será enviado normalmente
}

document.addEventListener("DOMContentLoaded", function () {
  // ✅ Garante que o DOM foi carregado antes de buscar os elementos

  // Ativa envio do formulário
  const form = document.getElementById("form-doacao");
  if (form) {
    form.addEventListener("submit", enviarFormulario);
  }

  // Ativa botão "Próxima Etapa"
